        ...
        <div ref={pageRef}>
            ...
            <section className="relative min-h-[50vh] flex items-center bg-[var(--noda-black)]">
                ...
                <div className="container resources-hero relative z-10 pt-32">
                    <p className="text-label text-[var(--noda-burgundy)] mb-4">{t("resourcesPage.hero.label")}</p>
                    <h1 className="text-h1 text-white">{t("resourcesPage.hero.title")}</h1>
                </div>
            </section>
            ...
            <section className="contact-section py-24 bg-[var(--noda-dark-2)]">
                <div className="container">
                    <div className="contact-info max-w-2xl">
                        <h2 className="text-h1 text-white mb-6">{t("resourcesPage.contact.title")}</h2>
                        ...
                        <div className="space-y-8">
                            <div>
                                <p className="text-label text-[var(--noda-gray-400)] mb-2">{t("resourcesPage.contact.email")}</p>
                            ...
                            <div>
                                <p className="text-label text-[var(--noda-gray-400)] mb-4">{t("resourcesPage.contact.portal")}</p>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <Button asChild>
                                        ...
                                        >
                                            {t("resourcesPage.contact.openContactForm")}
                                        </a>
                                    </Button>
                                </div>
                            </div>
