        ...
        <div ref={pageRef}>
            ...
            <section className="relative min-h-[70vh] flex items-center bg-[var(--noda-black)]">
                ...
                <div className="container innovation-hero relative z-10 pt-32">
                    <p className="text-label text-[var(--noda-burgundy)] mb-4">{t("innovationPage.hero.label")}</p>
                    <h1 className="text-h1 text-white max-w-4xl">
                        {t("innovationPage.hero.titlePrefix")}{" "}
                        <span className="gradient-text">{t("innovationPage.hero.titleHighlight")}</span>
                    </h1>
                </div>
            </section>
            ...
            <section className="values-section py-24 bg-[var(--noda-dark-2)]">
                <div className="container">
                    <h2 className="text-h1 text-white text-center mb-16">{t("innovationPage.values.title")}</h2>
            ...
            <section className="py-24 bg-[var(--noda-black)] text-center">
                <div className="container">
                    <h2 className="text-h1 text-white mb-6">{t("innovationPage.cta.title")}</h2>
                    <p className="text-body-lg text-[var(--noda-gray-300)] max-w-md mx-auto mb-8">
                        {t("innovationPage.cta.desc")}
                    </p>
                    <Button asChild size="lg">
                        <Link href="/resources">{t("innovationPage.cta.button")}</Link>
                    </Button>
                </div>
            </section>
