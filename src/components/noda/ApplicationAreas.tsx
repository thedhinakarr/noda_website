    ...
    const areas = [
        {
            ...
            title: "District Heating & Cooling",
            category: "Clean Energy",
            description: "Geothermal, HVAC systems, hydrogen integration, and heat pump optimization.",
        },
        {
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: "Smart energy management for campuses, hotels, schools, and municipal buildings.",
        },
        {
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            category: "Utilities",
            description: "Solutions for public and private energy providers to optimize distribution.",
        },
        {
            icon: (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: "AI-driven thermal optimization for manufacturing and processing facilities.",
        },
    ];
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                ...
                <div className="areas-header text-center mb-16">
                    ...
                    <p className="text-body-lg text-[var(--noda-gray-300)] max-w-2xl mx-auto">
                        Tailored AI-driven solutions delivering measurable results
                        wherever thermal energy flows.
                    </p>
                </div>
